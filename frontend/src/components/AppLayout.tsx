    ...
    <div className="h-screen bg-slate-50 flex overflow-hidden">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-navy-950 text-slate-100 flex-shrink-0 border-r border-navy-900 shadow-xl">
        ...
        <div className="p-4 border-t border-navy-900 bg-navy-950/60">
          <div className="flex items-center space-x-3 px-2 py-1">
            <UserAvatar name={user?.name} className="w-9 h-9 flex-shrink-0" />
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 shadow-sm z-10 flex-shrink-0">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <UserAvatar name={user?.name} className="w-8 h-8 flex-shrink-0" />
              ...
              <div
                className={`fixed inset-0 z-20 transition-opacity duration-150 ${
                  isProfileOpen ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'
                }`}
                onClick={() => setIsProfileOpen(false)}
              ></div>
              <div
                className={`absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-lg shadow-xl py-1 z-30 transform origin-top-right transition-all duration-150 ${
                  isProfileOpen
        ...
        <main 
          ...
          className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 animate-page-fade"
        >
      ...
      >
        ...
        {/* Drawer menu */}
        <div className={`relative flex flex-col w-64 max-w-xs bg-navy-950 text-slate-100 h-full shadow-2xl z-10 transition-transform duration-300 transform ${
